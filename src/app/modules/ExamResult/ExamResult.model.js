...
const ExamResultSchema = new Schema({
  ...
  overallStatus: { type: String, enum: ['Pass', 'Fail'], default: 'Pass' },   // ← নতুন
  gpa: { type: Number, default: 0 },                                          // ← নতুন
...
ExamResultSchema.index({ studentId: 1, examId: 1, sessionId: 1 }, { unique: true });
